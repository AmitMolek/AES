...
public class UserInfo implements Serializable {
	/**
	 * @author gal this DAO class is for transferring data between client and
	 *         server, when we want to get all teacher name's who wrote the
	 *         question's
	 */
	...
	/**
	 * this constructor is called when we have users ID (e.g in questions) and we
	 * want to get their names;
	 * 
	 * @param teachersMap
	 *            the teacher map
	 * @param questions
