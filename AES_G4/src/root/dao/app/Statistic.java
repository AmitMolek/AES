...
public class Statistic implements Serializable {
	/**
	 * @author Alon Ben-yosef Repersents a statistics item as described in the AES
	 *         DB, used to show histograms
	 */
	 ...
	 *            exam submitted students counter
	 * @param interrupted_students_counter
	 *            exam interrupted students
	 * @param students_started_counter
	 *            exam students started counter
	 * @param exams_avg
	 *            exam avg
	 * @param exams_median
	 *            exam median
	...
	/**
	 * Generate statistics by a list of grades, will calculate median and average
	 * independently
	 * 
	 * @param grades
	...
	public Statistic(List<Integer> grades) {
		...
		for (Integer grade : grades) {
			...
			if (grade.intValue() >= 0 && grade.intValue() <= 10)
				this.grade_derivative_0_10++;
			if (grade.intValue() >= 11 && grade.intValue() <= 20)
				this.grade_derivative_11_20++;
			if (grade.intValue() >= 21 && grade.intValue() <= 30)
				this.grade_derivative_21_30++;
			if (grade.intValue() >= 31 && grade.intValue() <= 40)
				this.grade_derivative_31_40++;
			if (grade.intValue() >= 41 && grade.intValue() <= 50)
				this.grade_derivative_41_50++;
			if (grade.intValue() >= 51 && grade.intValue() <= 60)
				this.grade_derivative_51_60++;
			if (grade.intValue() >= 61 && grade.intValue() <= 70)
				this.grade_derivative_61_70++;
			if (grade.intValue() >= 71 && grade.intValue() <= 80)
				this.grade_derivative_71_80++;
			if (grade.intValue() >= 81 && grade.intValue() <= 90)
				this.grade_derivative_81_90++;
			if (grade.intValue() >= 91 && grade.intValue() <= 100)
				this.grade_derivative_91_100++;
		}
