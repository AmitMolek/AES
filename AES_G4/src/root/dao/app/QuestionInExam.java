...
public class QuestionInExam {
	 ...
	 * @param questionGrade the question scoring points
	 * @param freeTextForTeacher the teacher free text(only teacher can see that)
	 * @param freeTextForStudent the free text for students
	 */
	 ...
	 * @param questionGrade the new question scoring
	 */
	 ...
	 * @param freeTextForTeacher the new free text for teacher
	 */
	...
	/**
	 * Set new free text for teacher
	 * @param freeTextForStudent the new free text for student
	 */
