...
public class ScreensManager extends Application {
	 ...
	 * 
	 * @param screenObj
	 *            the screen you want to add to the stack
	 */
	 ...
	 * 
	 * @param name
	 *            the key of the screen you want to activate
	 * @throws IOException
	 */
	 ...
	 * 
	 * @param screenObj
	 *            the screen object you want to activate
	 * @throws IOException
	 */
	 ...
	 * 
	 * @param screenName
	 *            the key of the screen you want to switch to
	 */
